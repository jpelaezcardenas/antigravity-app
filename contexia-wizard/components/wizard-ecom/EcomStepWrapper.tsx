...
interface EcomStepWrapperProps {
  step: 1 | 2 | 3;
  headline: string;
  subheadline?: string;
  children: ReactNode;
...
/**
 * Same visual language as components/wizard/StepWrapper.tsx (ctx-card,
 * ctx-btn-primary, etc.) but a separate component because that one
 * hardcodes "Paso X de 8" — wrong for this 3-step flow
 * (wizard-iva-ecom-express-diagnostic, design.md D1).
 */
export default function EcomStepWrapper({
  step,
  headline,
  subheadline,
  children,
