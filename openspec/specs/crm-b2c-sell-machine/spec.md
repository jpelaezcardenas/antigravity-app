...
The B2C "Renta Natural" sell-machine: a fixed 4-stage lead funnel (`crm_leads`) with a per-lead tax
profile, a payment-approval HITL gate, admin-only RLS, and a live Kanban view in the Búnker.
