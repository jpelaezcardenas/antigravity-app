...
| 3 | Obtain the Meta App Secret and set 4 Railway env vars (`WHATSAPP_APP_SECRET`, `WHATSAPP_WEBHOOK_VERIFY_TOKEN`, `META_APP_SECRET`, `META_WEBHOOK_VERIFY_TOKEN`) | `taty-channel-consolidation` | **WhatsApp inbound traffic is 100% rejected** until this is set — confirmed live 2026-08-13, unsigned webhook calls return `403` as designed. | `archive/2026-08-13-taty-channel-consolidation/tasks.md` §4 |
