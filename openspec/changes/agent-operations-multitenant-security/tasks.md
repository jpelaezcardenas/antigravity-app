...
5. **Railway deploy branch mismatch.** Service was anchored to `claude/angry-sutherland-976d5d`, not `main` → pushes to `main` never deployed. **Fix:** Repointed service to `main` via Railway dashboard. **Checkpoint:** "Verify service source branch is `main`, not a feature branch." **STATUS:** ✅ COMPLETE (2026-06-24).
