...
- [x] 11.1 Synced the new `crm-b2b-retainers` capability to `openspec/specs/crm-b2b-retainers/spec.md`
      and archived this change to `openspec/changes/archive/2026-07-19-crm-b2b-retainers-cockpit/`.
