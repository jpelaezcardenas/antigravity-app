...
- [ ] 4.5 Write a failing test asserting the endpoint responds in under 2 seconds for a tenant with 12 weeks of history; make it pass (optimize the query in step 1.2 if it fails). **Blocked** — needs real Supabase data volume; not measurable against mocks.
