...
export function FloatingSignOutButton() {
  return (
    <Link
      ...
      title="Cerrar sesión"
      className="fixed bottom-24 md:bottom-6 right-4 z-40 flex h-11 w-11 items-center justify-center rounded-full border border-[#2DD4BF]/40 bg-[#020617]/90 text-[#2DD4BF] shadow-[0_0_20px_rgba(45,212,191,0.25)] backdrop-blur transition-all hover:bg-[#020617] hover:border-[#2DD4BF]/70"
    >
