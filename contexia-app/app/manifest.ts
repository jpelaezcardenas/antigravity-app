...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      {
        src: "/icons/icon-192x192.png?v=2026091201",
        sizes: "192x192",
        type: "image/png",
        purpose: "any",
      },
      {
        src: "/icons/icon-192x192-maskable.png?v=2026091201",
        sizes: "192x192",
        type: "image/png",
        purpose: "maskable",
      },
      {
        src: "/icons/icon-512x512.png?v=2026091201",
        sizes: "512x512",
        type: "image/png",
        purpose: "any",
      },
      {
        src: "/icons/icon-512x512-maskable.png?v=2026091201",
        sizes: "512x512",
        type: "image/png",
        purpose: "maskable",
      },
