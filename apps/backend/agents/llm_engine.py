...
Implements automatic fallback chain: Groq → Cerebras → Mistral → Gemini → OpenRouter
...
class LLMEngine:
    ...
    def get_ai_response(
        ...
        for provider in self.provider_order:
            ...
            except (RateLimitError, APIError, APIConnectionError, requests.RequestException) as e:
