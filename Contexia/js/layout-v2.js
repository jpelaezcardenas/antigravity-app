...
document.addEventListener('DOMContentLoaded', () => {
    ...
    sidebar.innerHTML = `
        <a href="landing.html" class="h-16 shrink-0 flex items-center gap-3 px-6 border-b border-[#2D4A63] bg-[#0f172a] hover:bg-[#1E3D59] transition-colors cursor-pointer block text-decoration-none">
